...
We will respond to the [weaknesses of the paper](https://github.com/Changboyang/STR/blob/main/fail.png) one by one. Note that this content is not the same as a rebuttal.
